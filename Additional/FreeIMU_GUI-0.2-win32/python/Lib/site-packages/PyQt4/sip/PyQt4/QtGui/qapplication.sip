// qapplication.sip generated by MetaSIP on Sat Sep 29 12:38:30 2012
//
...
%ConvertToSubClassCode
    static struct class_graph {
        ...
        {sipName_QShortcut, &sipType_QShortcut, -1, 3},
        {sipName_QGraphicsTransform, &sipType_QGraphicsTransform, 39, 4},
        {sipName_QLayout, &sipType_QLayout, 41, 5},
        {sipName_QAbstractProxyModel, &sipType_QAbstractProxyModel, 47, 6},
        {sipName_QTextDocument, &sipType_QTextDocument, -1, 7},
        {sipName_QGraphicsItemAnimation, &sipType_QGraphicsItemAnimation, -1, 8},
        {sipName_QGuiApplication, &sipType_QGuiApplication, 49, 9},
        {sipName_QPyTextObject, &sipType_QPyTextObject, -1, 10},
        {sipName_QUndoGroup, &sipType_QUndoGroup, -1, 11},
        {sipName_QMouseEventTransition, &sipType_QMouseEventTransition, -1, 12},
        {sipName_QWidget, &sipType_QWidget, 50, 13},
        {sipName_QGraphicsEffect, &sipType_QGraphicsEffect, 126, 14},
        {sipName_QUndoStack, &sipType_QUndoStack, -1, 15},
        {sipName_QItemSelectionModel, &sipType_QItemSelectionModel, -1, 16},
        {sipName_QTextObject, &sipType_QTextObject, 130, 17},
        {sipName_QGraphicsScene, &sipType_QGraphicsScene, -1, 18},
        {sipName_QStringListModel, &sipType_QStringListModel, -1, 19},
        {sipName_QMovie, &sipType_QMovie, -1, 20},
        {sipName_QAbstractTextDocumentLayout, &sipType_QAbstractTextDocumentLayout, 134, 21},
        {sipName_QFileSystemModel, &sipType_QFileSystemModel, -1, 22},
        {sipName_QDirModel, &sipType_QDirModel, -1, 23},
        {sipName_QKeyEventTransition, &sipType_QKeyEventTransition, -1, 24},
        {sipName_QValidator, &sipType_QValidator, 135, 25},
        {sipName_QClipboard, &sipType_QClipboard, -1, 26},
        {sipName_QGraphicsObject, &sipType_QGraphicsObject, 138, 27},
        {sipName_QStandardItemModel, &sipType_QStandardItemModel, -1, 28},
        {sipName_QSessionManager, &sipType_QSessionManager, -1, 29},
        {sipName_QCompleter, &sipType_QCompleter, -1, 30},
        {sipName_QGraphicsAnchor, &sipType_QGraphicsAnchor, -1, 31},
        {sipName_QGesture, &sipType_QGesture, 141, 32},
        {sipName_QAbstractItemDelegate, &sipType_QAbstractItemDelegate, 146, 33},
        {sipName_QButtonGroup, &sipType_QButtonGroup, -1, 34},
        {sipName_QDataWidgetMapper, &sipType_QDataWidgetMapper, -1, 35},
        {sipName_QSyntaxHighlighter, &sipType_QSyntaxHighlighter, -1, 36},
        {sipName_QAction, &sipType_QAction, 148, 37},
        {sipName_QStyle, &sipType_QStyle, 149, 38},
        {sipName_QActionGroup, &sipType_QActionGroup, -1, -1},
        {sipName_QGraphicsRotation, &sipType_QGraphicsRotation, -1, 40},
        {sipName_QGraphicsScale, &sipType_QGraphicsScale, -1, -1},
        {sipName_QBoxLayout, &sipType_QBoxLayout, 45, 42},
        {sipName_QGridLayout, &sipType_QGridLayout, -1, 43},
        {sipName_QFormLayout, &sipType_QFormLayout, -1, 44},
        {sipName_QStackedLayout, &sipType_QStackedLayout, -1, -1},
        {sipName_QVBoxLayout, &sipType_QVBoxLayout, -1, 46},
        {sipName_QHBoxLayout, &sipType_QHBoxLayout, -1, -1},
        {sipName_QIdentityProxyModel, &sipType_QIdentityProxyModel, -1, 48},
        {sipName_QSortFilterProxyModel, &sipType_QSortFilterProxyModel, -1, -1},
        {sipName_QApplication, &sipType_QApplication, -1, -1},
        {sipName_QWizardPage, &sipType_QWizardPage, -1, 51},
        {sipName_QFrame, &sipType_QFrame, 78, 52},
        {sipName_QTabWidget, &sipType_QTabWidget, -1, 53},
        {sipName_QMdiSubWindow, &sipType_QMdiSubWindow, -1, 54},
        {sipName_QDialog, &sipType_QDialog, 100, 55},
        {sipName_QDesktopWidget, &sipType_QDesktopWidget, -1, 56},
        {sipName_QAbstractSlider, &sipType_QAbstractSlider, 112, 57},
        {sipName_QRubberBand, &sipType_QRubberBand, -1, 58},
        {sipName_QFocusFrame, &sipType_QFocusFrame, -1, 59},
        {sipName_QStatusBar, &sipType_QStatusBar, -1, 60},
        {sipName_QProgressBar, &sipType_QProgressBar, -1, 61},
        {sipName_QLineEdit, &sipType_QLineEdit, -1, 62},
        {sipName_QAbstractButton, &sipType_QAbstractButton, 115, 63},
        {sipName_QSplashScreen, &sipType_QSplashScreen, -1, 64},
        {sipName_QTabBar, &sipType_QTabBar, -1, 65},
        {sipName_QComboBox, &sipType_QComboBox, 120, 66},
        {sipName_QMenuBar, &sipType_QMenuBar, -1, 67},
        {sipName_QSizeGrip, &sipType_QSizeGrip, -1, 68},
        {sipName_QDialogButtonBox, &sipType_QDialogButtonBox, -1, 69},
        {sipName_QAbstractSpinBox, &sipType_QAbstractSpinBox, 121, 70},
        {sipName_QGroupBox, &sipType_QGroupBox, -1, 71},
        ...
        {sipName_QDockWidget, &sipType_QDockWidget, -1, 76},
        {sipName_QPrintPreviewWidget, &sipType_QPrintPreviewWidget, -1, 77},
        {sipName_QCalendarWidget, &sipType_QCalendarWidget, -1, -1},
        {sipName_QStackedWidget, &sipType_QStackedWidget, -1, 79},
        {sipName_QAbstractScrollArea, &sipType_QAbstractScrollArea, 84, 80},
        {sipName_QLCDNumber, &sipType_QLCDNumber, -1, 81},
        {sipName_QSplitter, &sipType_QSplitter, -1, 82},
        {sipName_QToolBox, &sipType_QToolBox, -1, 83},
        {sipName_QLabel, &sipType_QLabel, -1, -1},
        {sipName_QAbstractItemView, &sipType_QAbstractItemView, 90, 85},
        {sipName_QMdiArea, &sipType_QMdiArea, -1, 86},
        {sipName_QTextEdit, &sipType_QTextEdit, 99, 87},
        {sipName_QPlainTextEdit, &sipType_QPlainTextEdit, -1, 88},
        {sipName_QGraphicsView, &sipType_QGraphicsView, -1, 89},
        ...
        {sipName_QFileDialog, &sipType_QFileDialog, -1, 103},
        {sipName_QProgressDialog, &sipType_QProgressDialog, -1, 104},
        {sipName_QAbstractPrintDialog, &sipType_QAbstractPrintDialog, 111, 105},
        {sipName_QFontDialog, &sipType_QFontDialog, -1, 106},
        {sipName_QInputDialog, &sipType_QInputDialog, -1, 107},
        {sipName_QPrintPreviewDialog, &sipType_QPrintPreviewDialog, -1, 108},
        {sipName_QErrorMessage, &sipType_QErrorMessage, -1, 109},
        {sipName_QColorDialog, &sipType_QColorDialog, -1, 110},
        ...
        {sipName_QRadioButton, &sipType_QRadioButton, -1, 116},
        {sipName_QCheckBox, &sipType_QCheckBox, -1, 117},
        {sipName_QPushButton, &sipType_QPushButton, 119, 118},
        ...
        {sipName_QTextFrame, &sipType_QTextFrame, 132, 131},
        {sipName_QTextBlockGroup, &sipType_QTextBlockGroup, 133, -1},
        ...
        {sipName_QRegExpValidator, &sipType_QRegExpValidator, -1, 136},
        {sipName_QIntValidator, &sipType_QIntValidator, -1, 137},
        {sipName_QDoubleValidator, &sipType_QDoubleValidator, -1, -1},
        {sipName_QGraphicsWidget, &sipType_QGraphicsWidget, 140, 139},
        {sipName_QGraphicsTextItem, &sipType_QGraphicsTextItem, -1, -1},
        {sipName_QGraphicsProxyWidget, &sipType_QGraphicsProxyWidget, -1, -1},
        {sipName_QTapGesture, &sipType_QTapGesture, -1, 142},
        {sipName_QSwipeGesture, &sipType_QSwipeGesture, -1, 143},
        {sipName_QPinchGesture, &sipType_QPinchGesture, -1, 144},
        {sipName_QPanGesture, &sipType_QPanGesture, -1, 145},
        {sipName_QTapAndHoldGesture, &sipType_QTapAndHoldGesture, -1, -1},
        {sipName_QStyledItemDelegate, &sipType_QStyledItemDelegate, -1, 147},
