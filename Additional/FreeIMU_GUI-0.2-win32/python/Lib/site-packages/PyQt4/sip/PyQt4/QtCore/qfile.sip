// qfile.sip generated by MetaSIP on Sat Sep 29 12:38:29 2012
//
...
public:
    ...
    bool open(int fd, QFlags<QIODevice::OpenModeFlag> ioFlags, QFlags<QFileDevice::FileHandleFlag> handleFlags = QFileDevice::DontCloseHandle) /ReleaseGIL/;
