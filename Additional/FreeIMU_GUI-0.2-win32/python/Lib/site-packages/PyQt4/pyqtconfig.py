...
_pkg_config = {
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_Accessibility -x PyQt_NoPrintRangeBug -t Qt_4_8_3 -x Py_v3 -g',
    'pyqt_version':      0x040905,
    'pyqt_version_str':  '4.9.5',
    'qt_data_dir':       'C:\\Qt\\4.8.3',
    'qt_dir':            'C:\\Qt\\4.8.3',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'C:\\Qt\\4.8.3\\include',
    'qt_lib_dir':        'C:\\Qt\\4.8.3\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040803,
    'qt_winconfig':      'shared'
}
