...
<h3 class="fn"><a name="hotSpot" /><a href="qpoint.html">QPoint</a> QDrag.hotSpot (<i>self</i>)</h3><h3 class="fn"><a name="mimeData" /><a href="qmimedata.html">QMimeData</a> QDrag.mimeData (<i>self</i>)</h3><p>Returns the MIME data that is encapsulated by the drag
object.</p>
...
the mouse movements if the hot spot causes the pixmap to be
displayed directly under the cursor.</p>
<p><b>See also</b> <a href="qdrag.html#hotSpotx">hotSpot</a>().</p>
...
<address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.9.5 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://www.qtsoftware.com">Nokia</a> 2012</td><td align="right" width="25%">Qt&#160;4.8.3</td></tr></table></div></address></body></html>